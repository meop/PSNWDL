...
- Linux x86-64 and ARM64: DEB, RPM, Arch package, Alpine APK, and portable tarball
...
Portable assets use the platform's native architecture labels. Native Linux
packages keep the conventional filenames generated by nFPM:

| Artifact | Filename convention |
|---|---|
| Windows installer | `PSNWDL-<version>-windows-{x64,arm64}-installer.exe` |
| Windows portable | `PSNWDL-<version>-windows-{x64,arm64}-portable.zip` |
| Linux portable | `PSNWDL-<version>-linux-{x86_64,aarch64}-portable.tar.gz` |
...
| macOS portable | `PSNWDL-<version>-macos-{x86_64,arm64}-portable.zip` |
...
`0.1.1-rc.2`, the complete version/release portion is `0.1.1~rc.2-1` for
DEB/RPM, `0.1.1rc.2-1` for Arch, and `0.1.1_rc.2-r1` for Alpine.
